...
The setup for using Arrow in your project doesn't differ much from any other Kotlin library,
although some special steps are required for Android and Optics.
Check the [library reference](/learn/quickstart/libs) for the whole list of libraries
under the Arrow umbrella.
...
[typed errors](/learn/typed-errors/index.md) and suggests more idiomatic
