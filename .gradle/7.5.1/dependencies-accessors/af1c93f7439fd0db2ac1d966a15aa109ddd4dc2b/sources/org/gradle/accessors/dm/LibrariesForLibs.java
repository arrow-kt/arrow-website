...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    public static class KotlinxLibraryAccessors extends SubDependencyFactory {
        private final KotlinxKnitLibraryAccessors laccForKotlinxKnitLibraryAccessors = new KotlinxKnitLibraryAccessors(owner);

        public KotlinxLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Returns the group of libraries at kotlinx.knit
         */
        public KotlinxKnitLibraryAccessors getKnit() { return laccForKotlinxKnitLibraryAccessors; }

    }

    public static class KotlinxKnitLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {

        public KotlinxKnitLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

            /**
             * Creates a dependency provider for knit (org.jetbrains.kotlinx:kotlinx-knit)
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> asProvider() { return create("kotlinx.knit"); }

            /**
             * Creates a dependency provider for test (org.jetbrains.kotlinx:kotlinx-knit-test)
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> getTest() { return create("kotlinx.knit.test"); }
